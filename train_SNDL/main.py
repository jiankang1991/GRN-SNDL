...
from utils.model import ResNet18, ResNet50, InceptionV3, WideResNet50_2
from utils.metrics import KNNClassification, MetricTracker
from utils.LinearAverage import LinearAverage

model_choices = ['ResNet18', 'ResNet50', 'InceptionV3', 'WideResNet50']
...
def main():
    ...
    if args.model == "ResNet18":
        model = ResNet18(dim=args.dim)
    elif args.model == "ResNet50":
        model = ResNet50(dim=args.dim)
    elif args.model == 'InceptionV3':
        model = InceptionV3(dim=args.dim)
    elif args.model == 'WideResNet50':
        model = WideResNet50_2(dim=args.dim)
    else:
        print('no model')
